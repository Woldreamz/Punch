...
// Functional component definition for the Banner
const Banner = () => {
    ...
    >
      ...
      <div className="flex items-end justify-end">
        ...
        <div className="relative lg:hidden z-10">
          ...
          {/* Mobile menu items */}
          {menuOpen && (
            <ul className="absolute right-0 mt-4 p-1 px-2 shadow bg-[#525AA0] w-auto rounded-lg z-50 flex flex-col space-x-5" style={{ top: '100%' }}>
